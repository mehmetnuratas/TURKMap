...
// İndirimler tablosunu al
$discount_sql = "SELECT * FROM indirimler";
...
if ($discount_result->num_rows > 0) {
    ...
    $errorMessage = "Hiç indirim bulunamadı.";
}
...
<body>
    ...
    <div id="panel">
        ...
        <button onclick="showDiscounts()">İndirimleri Göster</button>
        ...
        <div id="discounts-container" style="display: none;">
            ...
            <ul id="discounts-list">
                <?php foreach ($discounts as $discount): ?>
                    <li>
                        <strong>Restoran Adı:</strong> <?= $discount['restoran_adi'] ?> <br>
                        <strong>Açıklama:</strong> <?= $discount['aciklama'] ?> <br>
                        <strong>Başlangıç Tarihi:</strong> <?= $discount['baslangic_tarihi'] ?> <br>
                        <strong>Bitiş Tarihi:</strong> <?= $discount['bitis_tarihi'] ?> <br>
                        <strong>İndirim Yüzdesi:</strong> <?= $discount['yuzde'] ?>% <br><br>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
        ...
        <div id="weather-container">
            <div class="task">  <iframe class="iframe-content" src="http://localhost/mehmet.php"></iframe></div>
    ...
    <script>
        ...
        // İndirimleri göstermek için fonksiyon
        function showDiscounts() {
            const discountsContainer = document.getElementById('discounts-container');
            if (discountsContainer.style.display === 'none') {
